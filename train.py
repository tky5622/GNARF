...
# CHANGE: projector and masking for points to project GNARF
...
def main(**kwargs):
    ...
    c.D_kwargs.disc_c_noise = opts.disc_c_noise # Regularization for discriminator pose conditioning # GNARF use fixed "0" 
    ...
    rendering_options = {
        ...
        'gpc_reg_prob': opts.gpc_reg_prob if opts.gen_pose_cond else None, # panic3d
        ...
        'sr_antialias': True,
        'cfg_name': opts.cfg, # name of the cfg # GNARF
    }
    #GNARF do this
